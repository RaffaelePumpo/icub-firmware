...
extern void process_sensors(const boolean_T *rtu_calibDone, const SensorsData
  *rtu_SensorData, const ActuatorConfiguration *rtu_ActuatorConfig, SensorsData *
  rty_SensorData_decoded, B_process_sensors_c_T *localB, DW_process_sensors_f_T *
